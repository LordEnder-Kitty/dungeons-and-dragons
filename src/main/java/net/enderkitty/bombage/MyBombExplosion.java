...
public class MyBombExplosion extends CustomExplosion {
    private static final ExplosionBehavior DEFAULT_BEHAVIOR = new ExplosionBehavior();

    public MyBombExplosion(World world, Entity entity, double x, double y, double z, float power, DestructionType destructionType) {
    ...
    public void affectWorld(boolean particles) {
        ...
        if (bl) {
            ...
            Collections.shuffle(this.affectedBlocks, random);
                ...
                if (!world.isClient()) {
                    ...
                    for (Direction direction : Direction.values()) {
                        ...
                        if (optional.isPresent() && optional.get().floatValue() < 1200 && !this.affectedBlocks.contains(mutable.set(blockPos, direction))) {
                            world.setBlockState(mutable.set(blockPos, direction), Blocks.FIRE.getDefaultState());
                        }
                    }

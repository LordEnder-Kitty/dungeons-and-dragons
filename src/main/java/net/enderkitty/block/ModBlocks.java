...
public class ModBlocks {
    ...
    public static final Block ADVENTURING_TABLE = registerBlock("adventuring_table",
            ...
            ModItemGroup.MISC, "tooltip.dndmod.adventuring_table");

    public static final Block FOG_BLOCK = registerBlock("fog_block",
            new Block(FabricBlockSettings.of(Material.WOOL).strength(-1f).nonOpaque().noCollision().sounds(BlockSoundGroup.WOOL)), ModItemGroup.MISC);

    public static final Block SILVER_BLOCK = registerBlock("silver_block",
            new Block(FabricBlockSettings.of(Material.METAL).strength(6f).requiresTool().sounds(BlockSoundGroup.NETHERITE)), ModItemGroup.MISC);
    public static final Block RAW_SILVER_BLOCK = registerBlock("raw_silver_block",
            new Block(FabricBlockSettings.of(Material.STONE).strength(6f).requiresTool()), ModItemGroup.MISC);
    public static final Block SILVER_ORE = registerBlock("silver_ore",
            new OreBlock(FabricBlockSettings.of(Material.STONE).strength(6f).requiresTool(),
                    UniformIntProvider.create(3, 7)), ModItemGroup.MISC);
    public static final Block DEEPSLATE_SILVER_ORE = registerBlock("deepslate_silver_ore",
            new OreBlock(FabricBlockSettings.of(Material.STONE).strength(6.5f).requiresTool().sounds(BlockSoundGroup.DEEPSLATE),
                    UniformIntProvider.create(4, 8)), ModItemGroup.MISC);
    ...
    public static final Block SILVERED_BLACKSTONE = registerBlock("silvered_blackstone",
            new OreBlock(FabricBlockSettings.of(Material.STONE).strength(4.5f).requiresTool().sounds(BlockSoundGroup.GILDED_BLACKSTONE),
                    UniformIntProvider.create(1, 5)), ModItemGroup.MISC);
    public static final Block CHISELED_SILVER_BLOCK = registerBlock("chiseled_silver_block",
            new Block(FabricBlockSettings.of(Material.STONE).strength(5.6f).requiresTool()), ModItemGroup.MISC);
    public static final Block CRACKED_SILVER_BLOCK = registerBlock("cracked_silver_block",
            new Block(FabricBlockSettings.of(Material.STONE).strength(5.6f).requiresTool()
                    .sounds(BlockSoundGroup.NETHERITE)), ModItemGroup.MISC);
    ...
    public static final Block ELECTRUM_BLOCK = registerBlock("electrum_block",
            new Block(FabricBlockSettings.of(Material.METAL).strength(6f).requiresTool()
                    .sounds(BlockSoundGroup.COPPER)), ModItemGroup.MISC);
    ...
    public static final Block ELECTRUM_ORE = registerBlock("electrum_ore",
            new OreBlock(FabricBlockSettings.of(Material.STONE).strength(6f).requiresTool(),
                    UniformIntProvider.create(2, 6)), ModItemGroup.MISC);
    ...
    public static final Block RAW_PLATINUM_BLOCK = registerBlock("raw_platinum_block",
            new Block(FabricBlockSettings.of(Material.METAL).strength(6f).requiresTool()), ModItemGroup.MISC);
    public static final Block PLATINUM_ORE = registerBlock("platinum_ore",
            new OreBlock(FabricBlockSettings.of(Material.STONE).strength(6f).requiresTool(),
                    UniformIntProvider.create(1, 3)), ModItemGroup.MISC);
...
//            new AleKegBlock(FabricBlockSettings.copyOf(ModBlocks.KEG)), ModItemGroup.THE_TAVERN);
    ...
    public static final Block PRONE_SKELETON = registerBlock("prone_skeleton",
            new BodyProneBlock(null, FabricBlockSettings.of(Material.STONE).strength(2.5f).requiresTool()
                    .nonOpaque().noCollision().sounds(BlockSoundGroup.BONE)), ModItemGroup.MISC);
    ...
    public static final Block SKELETON_PRONE_HEAD_HALF = registerBlock("skeleton_prone_head_half",
            new SkeletonProneHeadHalfBlock(FabricBlockSettings.of(Material.STONE).strength(3f).requiresTool()
                    .nonOpaque().sounds(BlockSoundGroup.BONE)), ModItemGroup.MISC);
    ...
    public static final Block IMMOVABLE_LOG = registerBlock("immovable_log", createImmovableLogBlock
            (MapColor.OAK_TAN, MapColor.SPRUCE_BROWN), ModItemGroup.MISC);

    public static final Block ALDER_LEAVES = registerBlock("alder_leaves",
            new LeavesBlock(FabricBlockSettings.copy(Blocks.BIRCH_LEAVES)), ModItemGroup.MISC);
    public static final Block ALDER_LOG = registerBlock("alder_log",
            new PillarBlock(FabricBlockSettings.copy(Blocks.BIRCH_LOG)), ModItemGroup.MISC);
    public static final Block ALDER_WOOD = registerBlock("alder_wood",
            new PillarBlock(FabricBlockSettings.copy(Blocks.BIRCH_WOOD)), ModItemGroup.MISC);
    public static final Block STRIPPED_ALDER_LOG = registerBlock("stripped_alder_log",
            new PillarBlock(FabricBlockSettings.copy(Blocks.STRIPPED_BIRCH_LOG)), ModItemGroup.MISC);
    public static final Block STRIPPED_ALDER_WOOD = registerBlock("stripped_alder_wood",
            new PillarBlock(FabricBlockSettings.copy(Blocks.STRIPPED_BIRCH_WOOD)), ModItemGroup.MISC);
    public static final Block ALDER_PLANKS = registerBlock("alder_planks",
            new Block(FabricBlockSettings.copy(Blocks.BIRCH_PLANKS)), ModItemGroup.MISC);
    public static final Block ALDER_SAPLING = registerBlock("alder_sapling",
            new SaplingBlock(new AlderSaplingGenerator(), FabricBlockSettings.copy(Blocks.BIRCH_SAPLING)), ModItemGroup.MISC);
    public static final Block ALDER_BUTTON = registerBlock("alder_button",
            new WoodenButtonBlock(FabricBlockSettings.of(Material.WOOD).strength(2.0f, 3.0f)
                    .requiresTool().noCollision().sounds(BlockSoundGroup.WOOD)), ModItemGroup.MISC);
    ...
    public static final Block ALDER_FENCE = registerBlock("alder_fence",
            new FenceBlock(FabricBlockSettings.of(Material.WOOD).strength(2.0f, 3.0f)
                    .requiresTool().sounds(BlockSoundGroup.WOOD)), ModItemGroup.MISC);
    ...
    public static final Block ALDER_DOOR = registerBlock("alder_door",
            new DoorBlock(FabricBlockSettings.of(Material.WOOD).strength(2.0f, 3.0f)
                    .requiresTool().nonOpaque().sounds(BlockSoundGroup.WOOD)), ModItemGroup.MISC);
    ...
    public static final Block ASH_SAPLING = registerBlock("ash_sapling",
            new SaplingBlock(new AshSaplingGenerator(), FabricBlockSettings.copy(Blocks.BIRCH_SAPLING)), ModItemGroup.MISC);
    ...
    public static final Block BALSA_SAPLING = registerBlock("balsa_sapling",
            new SaplingBlock(new BalsaSaplingGenerator(), FabricBlockSettings.copy(Blocks.BIRCH_SAPLING)), ModItemGroup.MISC);

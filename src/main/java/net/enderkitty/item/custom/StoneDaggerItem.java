...
public class StoneDaggerItem extends Item implements Vanishable {
    ...
    public StoneDaggerItem(Settings settings) {
        ...
        builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(ATTACK_DAMAGE_MODIFIER_ID, "Tool modifier", 2.8f, Operation.ADDITION));

...
public class DiamondDaggerItem extends Item implements Vanishable {
    ...
    public DiamondDaggerItem(Settings settings) {
        ...
        builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(ATTACK_DAMAGE_MODIFIER_ID, "Tool modifier", 4.5f, Operation.ADDITION));

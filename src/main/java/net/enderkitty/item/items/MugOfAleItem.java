...
public class MugOfAleItem extends BlockItem {
    public static final int MAX_US_TIME = 35;

    public MugOfAleItem(Block block, Settings settings) {super(block, settings);}

...
public class ThrowableItem extends Item implements Vanishable {
    ...
    public ThrowableItem(Settings settings) {
        ...
        builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(ATTACK_DAMAGE_MODIFIER_ID, "Tool modifier", 4f, Operation.ADDITION));

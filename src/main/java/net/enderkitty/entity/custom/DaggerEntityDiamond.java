...
public class DaggerEntityDiamond extends PersistentProjectileEntity implements IAnimatable {
    ...
    private ItemStack daggerStack = new ItemStack(ModItems.DIAMOND_DAGGER);
    private boolean dealtDamage;
    public int returnTimer;

    private AnimationFactory factory = new AnimationFactory(this);

    public DaggerEntityDiamond(EntityType<? extends DaggerEntityDiamond> entityType, World world) {
        super((EntityType<? extends PersistentProjectileEntity>)entityType, world);
    }

    public DaggerEntityDiamond(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.DAGGER_DIAMOND, owner, world);

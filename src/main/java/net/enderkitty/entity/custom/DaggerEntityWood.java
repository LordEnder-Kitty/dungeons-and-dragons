...
public class DaggerEntityWood extends PersistentProjectileEntity implements IAnimatable {
    ...
    private ItemStack daggerStack = new ItemStack(ModItems.WOODEN_DAGGER);
    private boolean dealtDamage;
    public int returnTimer;

    private AnimationFactory factory = new AnimationFactory(this);

    public DaggerEntityWood(EntityType<? extends DaggerEntityWood> entityType, World world) {
        super((EntityType<? extends PersistentProjectileEntity>)entityType, world);
    }

    public DaggerEntityWood(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.DAGGER_WOOD, owner, world);

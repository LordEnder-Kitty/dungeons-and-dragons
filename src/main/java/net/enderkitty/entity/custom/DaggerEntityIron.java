...
public class DaggerEntityIron extends PersistentProjectileEntity implements IAnimatable {
    ...
    public DaggerEntityIron(EntityType<? extends DaggerEntityIron> entityType, World world) {
        super((EntityType<? extends PersistentProjectileEntity>)entityType, world);
    }

    public DaggerEntityIron(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.DAGGER_IRON, owner, world);

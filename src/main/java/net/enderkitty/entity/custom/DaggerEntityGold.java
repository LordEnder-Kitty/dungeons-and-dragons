...
public class DaggerEntityGold extends PersistentProjectileEntity implements IAnimatable {
    ...
    private ItemStack daggerStack = new ItemStack(ModItems.GOLDEN_DAGGER);
    private boolean dealtDamage;
    public int returnTimer;

    private AnimationFactory factory = new AnimationFactory(this);

    public DaggerEntityGold(EntityType<? extends DaggerEntityGold> entityType, World world) {
        super((EntityType<? extends PersistentProjectileEntity>)entityType, world);
    }

    public DaggerEntityGold(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.DAGGER_GOLD, owner, world);

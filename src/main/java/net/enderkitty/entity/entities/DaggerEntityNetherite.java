...
public class DaggerEntityNetherite extends PersistentProjectileEntity implements IAnimatable {
    ...
    private ItemStack daggerStack = new ItemStack(ModItems.NETHERITE_DAGGER);
    private boolean dealtDamage;
    public int returnTimer;

    private AnimationFactory factory = new AnimationFactory(this);

    public DaggerEntityNetherite(EntityType<? extends DaggerEntityNetherite> entityType, World world) {
        super((EntityType<? extends PersistentProjectileEntity>)entityType, world);
    }

    public DaggerEntityNetherite(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.DAGGER_NETHERITE, owner, world);
